...
public class FindPswActivity extends AppCompatActivity {
    ...
    //从哪个界面跳转过来的（from为security时是从设置密保界面跳转过来的，否则就省从登录界面跳转过来的）
    private String from;
    ...
    **获取界面控件及处理相应控件的点击事件
    ...
    private void saveSecurity(String validateName){
        SharedPreferences sp = getSharedPreferences("loginInfo",MODE_PRIVATE);// ligon表示文件名
        SharedPreferences.Editor editor = sp.edit();// 获取编辑器
        // 存入账号对应密保
    ...
    /*
    从sharedperference中根据用户输入的用户名来判断是否有此用户名
     */
